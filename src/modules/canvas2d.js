...
Q42Logo['Canvas'].prototype = {
	...
	drawLogo: function(){
		...
		ctx.translate(-33.3,-33.3*this.ratio);
	...
	setSize: function(){
		this.element.width = this.logo.element.clientWidth;
		this.element.height = this.logo.element.clientHeight;
		this.draw();
	}
};
