...
Q42Logo.WebGL.prototype = {
	...
	// This is just the triangles for a simple rectangle (corner points: {-.36, -.25} and {.36, .85}), except it's modeled as 5x5 rectangles (with 2 triangles per rect) so that the vertex shader can warp it flexibly enough that there won't be gaps between it and the main vector
	whiteQuad: new Float32Array([-.36,-.25,-.216,-.25,-.36,-.03,-.216,-.25,-.216,-.03,-.36,-.03,-.36,-.03,-.216,-.03,-.36,.19,-.216,-.03,-.216,.19,-.36,.19,-.36,.19,-.216,.19,-.36,.41,-.216,.19,-.216,.41,-.36,.41,-.36,.41,-.216,.41,-.36,.63,-.216,.41,-.216,.63,-.36,.63,-.36,.63,-.216,.63,-.36,.85,-.216,.63,-.216,.85,-.36,.85,-.216,-.25,-.072,-.25,-.216,-.03,-.072,-.25,-.072,-.03,-.216,-.03,-.216,-.03,-.072,-.03,-.216,.19,-.072,-.03,-.072,.19,-.216,.19,-.216,.19,-.072,.19,-.216,.41,-.072,.19,-.072,.41,-.216,.41,-.216,.41,-.072,.41,-.216,.63,-.072,.41,-.072,.63,-.216,.63,-.216,.63,-.072,.63,-.216,.85,-.072,.63,-.072,.85,-.216,.85,-.072,-.25,.072,-.25,-.072,-.03,.072,-.25,.072,-.03,-.072,-.03,-.072,-.03,.072,-.03,-.072,.19,.072,-.03,.072,.19,-.072,.19,-.072,.19,.072,.19,-.072,.41,.072,.19,.072,.41,-.072,.41,-.072,.41,.072,.41,-.072,.63,.072,.41,.072,.63,-.072,.63,-.072,.63,.072,.63,-.072,.85,.072,.63,.072,.85,-.072,.85,.072,-.25,.216,-.25,.072,-.03,.216,-.25,.216,-.03,.072,-.03,.072,-.03,.216,-.03,.072,.19,.216,-.03,.216,.19,.072,.19,.072,.19,.216,.19,.072,.41,.216,.19,.216,.41,.072,.41,.072,.41,.216,.41,.072,.63,.216,.41,.216,.63,.072,.63,.072,.63,.216,.63,.072,.85,.216,.63,.216,.85,.072,.85,.216,-.25,.36,-.25,.216,-.03,.36,-.25,.36,-.03,.216,-.03,.216,-.03,.36,-.03,.216,.19,.36,-.03,.36,.19,.216,.19,.216,.19,.36,.19,.216,.41,.36,.19,.36,.41,.216,.41,.216,.41,.36,.41,.216,.63,.36,.41,.36,.63,.216,.63,.216,.63,.36,.63,.216,.85,.36,.63,.36,.85,.216,.85]),
	...
	mousemove: function(e){
		...
		var height = this.logo.element.clientHeight + this.margin;
		this.uniformValues['mousePos'][0] = ((e.clientX - rect.left) - width/2) / width * 2 * this.scale;
		this.uniformValues['mousePos'][1] = (height/2 - (e.clientY - rect.top)) / height * 2 * this.scale;
	},
