...
struct Q42: View {
    ...
    init(backgroundColor: Color = .q42Green, foregroundColor: Color = .white) {
...
struct Q42_Previews: PreviewProvider {
  static var previews: some View {
    Group {
      Q42()
      Q42(backgroundColor: .black, foregroundColor: .white)
      Q42(backgroundColor: .white, foregroundColor: .black)
